      ...
      <>
        ...
        <main className="rightbarFollowings">
          <article className="rightbarFollowing">
            <img
              src={`${PF}person/person3-unsplash.jpg`}
              alt="following"
          ...
          <article className="rightbarFollowing">
            <img
              src={`${PF}person/person4-unsplash.jpg`}
              alt="following"
              className="rightbarfollowingImg"
            />
            <span className="rightbarFollowingName">John Doe</span>
          ...
          <article className="rightbarFollowing">
            <img
              src={`${PF}person/person5-unsplash.jpg`}
              alt="following "
              className="rightbarfollowingImg"
            />
            <span className="rightbarFollowingName">John Doe</span>
          ...
          <article className="rightbarFollowing">
            <img
              src={`${PF}person/person6-unsplash.jpg`}
              alt="following "
              className="rightbarfollowingImg"
            />
            <span className="rightbarFollowingName">John Doe</span>
          ...
          <article className="rightbarFollowing">
            <img
              src={`${PF}person/person8-unsplash.jpg`}
              alt="following "
              className="rightbarfollowingImg"
            />
            <span className="rightbarFollowingName">John Doe</span>
